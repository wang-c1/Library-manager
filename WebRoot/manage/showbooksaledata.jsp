		...
		<div id="managePage"
			...
			<div style="width: 80%" align="center">
				<div style="float: left; margin-top: 3px; margin-right: 30px">
					...
					<div id="plateb" style="width:600px;height:400px;"></div>
				</div>
			</div>
		</div>
...
$.ajax({
	...
	success:function (data) {
        ...
        var dataSec = [];
        var i = 0;
        for(i = 0;i<data.plab.length;i++)
        {
          var vall,namm;
          namm = data.plab[i].nam;
          vall = data.plab[i].val;
          dataFir[i] = namm;
          dataSec[i] = {
                  value:vall,
                  name:namm
        ...
        var myChart = echarts.init(document.getElementById('plateb'));
		var option = {
			    title : {
			        text: '图书销售统计玫瑰图',
			        //subtext: '纯属虚构',
